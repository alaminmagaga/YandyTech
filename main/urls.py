...
urlpatterns = [
    ...
    path('track/edit/<int:pk>',EditTrackView.as_view(),name='edit-track'),
    path('track/<int:pk>/remove',DeleteTrackView.as_view(),name='delete-track'),
    ...
    path('add_track/',AddTrackPost.as_view(),name='add-track'),
